...
SMTP_FROM_NAME = os.getenv('SMTP_FROM_NAME', 'MaxGamer')  # 发件人名称

# SendGrid配置
SENDGRID_API_KEY = os.getenv('SENDGRID_API_KEY', '')  # SendGrid API密钥
SENDGRID_FROM_EMAIL = os.getenv('SENDGRID_FROM_EMAIL', '')  # 发件人邮箱
SENDGRID_FROM_NAME = os.getenv('SENDGRID_FROM_NAME', 'MaxGamer')  # 发件人名称
...
def send_email_code_sendgrid(email: str, code: str, purpose: str) -> bool:
    ...
    try:
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="footer">
                        <p>此邮件由系统自动发送，请勿回复</p>
                        <p>© 2025 MaxGamer. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </body>
        ...
        message = Mail(
            ...
            to_emails=To(email),
            subject=f'【MaxGamer】{purpose_text}验证码',
...
def send_email_code_smtp(email: str, code: str, purpose: str) -> bool:
    ...
    try:
        ...
        msg['Subject'] = f'【MaxGamer】{purpose_text}验证码'
