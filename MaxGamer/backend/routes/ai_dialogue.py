...
def chat():
    ...
    请求体:
    {
        ...
        "context": {
            ...
            "page": "login",
            "count": 当前交互次数（可选）,
            "language": 当前语言（可选，如 "en-US", "zh-CN" 等）
        }
    }
    ...
    try:
        ...
        language = context.get('language', 'zh-CN')  # 获取语言设置，默认中文
        ...
        # 语言指令
        language_instruction = f"\n\n【语言要求】请用{language_name}回复，保持简短自然。"
...
【重要】直接给出你的回复，不要包含任何标签！{language_instruction}''',
